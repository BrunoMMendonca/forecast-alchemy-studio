-- =====================================================
-- S&OP System Database Creation Script (FIXED)
-- DBeaver Compatible
-- =====================================================
-- 
...
-- =====================================================
-- 2. CREATE S&OP CYCLES TABLE (FIXED - Added config_id)
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '- sop_cycles (Generated S&OP cycles) - FIXED with config_id column';
