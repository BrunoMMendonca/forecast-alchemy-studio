...
async function testManualImportWithCreatedBy() {
  try {
    console.log('Testing manual import with created_by column...');
    ...
    console.log('✅ Manual import successful with created_by!');
