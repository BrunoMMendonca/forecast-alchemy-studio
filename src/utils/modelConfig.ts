...
// Deprecated: getDefaultModels is no longer used. Use fetchAvailableModels instead.
...
export const hasOptimizableParameters = (model: any): boolean => {
  return model.defaultParameters && Object.keys(model.defaultParameters).length > 0;
};
